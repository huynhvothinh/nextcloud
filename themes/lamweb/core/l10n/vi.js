   ...
   "core",
{
    ...
    "Could not load your contacts": "Không thể tải địa chỉ liên hệ của bạn ",
    ...
    "_Problem loading page, reloading in %n second_::_Problem loading page, reloading in %n seconds_": [
        "Xảy ra lỗi khi tải trang, tải lại trong %n giây"
    ],
    "Saving...": "Đang lưu...",
    "Dismiss": "Bỏ qua",
    ...
    "Your web server is not properly set up to resolve \"{url}\". Further information can be found in the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">documentation</a>.": "Máy chủ web của bạn không được thiết lập đúng để giải quyết \"{url}\". Bạn có thể tìm thêm thông tin trong <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\"> tài liệu </a>. ",
    "This server has no working Internet connection: Multiple endpoints could not be reached. This means that some of the features like mounting external storage, notifications about updates or installation of third-party apps will not work. Accessing files remotely and sending of notification emails might not work, either. Establish a connection from this server to the Internet to enjoy all features.": "Máy chủ này không có kết nối Internet hoạt động: Không thể kết nối nhiều điểm cuối. Điều này có nghĩa là một số tính năng như gắn bộ nhớ ngoài, thông báo về cập nhật hoặc cài đặt ứng dụng của bên thứ ba sẽ không hoạt động. Truy cập các tập tin từ xa và gửi email thông báo có thể không hoạt động. Thiết lập kết nối từ máy chủ này với Internet để tận hưởng tất cả các tính năng. ",
    "No memory cache has been configured. To enhance performance, please configure a memcache, if available. Further information can be found in the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">documentation</a>.": "Không có bộ nhớ cache nào được định cấu hình. Để nâng cao hiệu suất, vui lòng định cấu hình memcache, nếu có. Bạn có thể tìm thêm thông tin trong <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\"> tài liệu </a>. ",
    "/dev/urandom is not readable by PHP which is highly discouraged for security reasons. Further information can be found in the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">documentation</a>.": "/ dev / urandom không thể đọc được bởi PHP vốn không được khuyến khích vì lý do bảo mật. Bạn có thể tìm thêm thông tin trong <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\"> tài liệu </a>. ",
    "You are currently running PHP {version}. Upgrade your PHP version to take advantage of <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{phpLink}\">performance and security updates provided by the PHP Group</a> as soon as your distribution supports it.": "Bạn hiện đang chạy PHP {version}. Nâng cấp phiên bản PHP của bạn để tận dụng lợi thế của <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{phpLink}\"> các cập nhật về hiệu suất và bảo mật được cung cấp bởi Nhóm PHP </a> ngay khi phân phối của bạn hỗ trợ nó. ",
    "You are currently running PHP 5.6. The current major version of Nextcloud is the last that is supported on PHP 5.6. It is recommended to upgrade the PHP version to 7.0+ to be able to upgrade to Nextcloud 14.": "Bạn hiện đang chạy PHP 5.6. Phiên bản chính hiện tại của Nextcloud là phiên bản cuối cùng được hỗ trợ trên PHP 5.6. Bạn nên nâng cấp phiên bản PHP lên 7.0+ để có thể nâng cấp lên Nextcloud 14. ",
    "The reverse proxy header configuration is incorrect, or you are accessing Nextcloud from a trusted proxy. If not, this is a security issue and can allow an attacker to spoof their IP address as visible to the Nextcloud. Further information can be found in the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">documentation</a>.": "Cấu hình tiêu đề proxy ngược không chính xác hoặc bạn đang truy cập Nextcloud từ proxy đáng tin cậy. Nếu không, đây là vấn đề bảo mật và có thể cho phép kẻ tấn công giả mạo địa chỉ IP của họ hiển thị với Nextcloud. Bạn có thể tìm thêm thông tin trong <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\"> tài liệu </a>. ",
    "Memcached is configured as distributed cache, but the wrong PHP module \"memcache\" is installed. \\OC\\Memcache\\Memcached only supports \"memcached\" and not \"memcache\". See the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{wikiLink}\">memcached wiki about both modules</a>.": "Memcached được cấu hình như bộ nhớ cache phân tán, nhưng mô-đun PHP sai \"memcache\" được cài đặt. \\ OC \\ Memcache \\ Memcached chỉ hỗ trợ \"memcached\" chứ không phải \"memcache\". Xem <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{wikiLink}\"> wiki được ghi nhớ về cả hai mô-đun </a>. ",
    "Some files have not passed the integrity check. Further information on how to resolve this issue can be found in the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">documentation</a>. (<a href=\"{codeIntegrityDownloadEndpoint}\">List of invalid files…</a> / <a href=\"{rescanEndpoint}\">Rescan…</a>)": "Một số tệp chưa vượt qua kiểm tra tính toàn vẹn. Bạn có thể tìm thêm thông tin về cách giải quyết vấn đề này trong <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\"> tài liệu </a>. (<a href=\"{codeIntegrityDownloadEndpoint}\"> Danh sách các tệp không hợp lệ ... </a> / <a href=\"{rescanEndpoint}\"> Rescan… </a>) ",
    ...
    "The PHP function \"set_time_limit\" is not available. This could result in scripts being halted mid-execution, breaking your installation. Enabling this function is strongly recommended.": "Chức năng PHP \"set_time_limit\" không khả dụng. Điều này có thể dẫn đến các tập lệnh bị tạm dừng giữa quá trình thực thi, phá vỡ cài đặt của bạn. Việc bật chức năng này được khuyến khích mạnh mẽ. ",
    ...
    "Your data directory and files are probably accessible from the Internet. The .htaccess file is not working. It is strongly recommended that you configure your web server so that the data directory is no longer accessible, or move the data directory outside the web server document root.": "Thư mục dữ liệu và tệp của bạn có thể truy cập được từ Internet. Tệp .htaccess không hoạt động. Chúng tôi khuyên bạn nên định cấu hình máy chủ web của mình để thư mục dữ liệu không còn truy cập được nữa hoặc di chuyển thư mục dữ liệu bên ngoài gốc tài liệu máy chủ web. ",
    "The \"{header}\" HTTP header is not set to \"{expected}\". This is a potential security or privacy risk, as it is recommended to adjust this setting accordingly.": "Tiêu đề HTTP \"{header}\" không được đặt thành \"{expected}\". Đây là rủi ro bảo mật hoặc quyền riêng tư tiềm ẩn, vì bạn nên điều chỉnh cài đặt này cho phù hợp. ",
    ...
    "The \"Strict-Transport-Security\" HTTP header is not set to at least \"{seconds}\" seconds. For enhanced security, it is recommended to enable HSTS as described in the <a href=\"{docUrl}\" rel=\"noreferrer noopener\">security tips</a>.": "Tiêu đề HTTP \"Nghiêm ngặt Giao thông-Bảo mật\" không được đặt thành ít nhất \"{giây}\" giây. Để tăng cường bảo mật, bạn nên bật HSTS như được mô tả trong <a href=\"{docUrl}\" rel=\"noreferrer noopener\"> mẹo bảo mật </a>. ",
    "Accessing site insecurely via HTTP. You are strongly adviced to set up your server to require HTTPS instead, as described in the <a href=\"{docUrl}\">security tips</a>.": "Truy cập trang web không an toàn qua HTTP. Bạn được khuyến khích mạnh mẽ để thiết lập máy chủ của mình yêu cầu HTTPS thay vào đó, như được mô tả trong <a href=\"{docUrl}\"> mẹo bảo mật </a>. ",
    "Shared": "Được chia sẻ",
    ...
    "_At least {count} character is needed for autocompletion_::_At least {count} characters are needed for autocompletion_": [
        "Cần ít nhất {count} ký tự cho tự động hoàn thành"
    ],
    ...
    "_The update was successful. Redirecting you to Nextcloud in %n second._::_The update was successful. Redirecting you to Nextcloud in %n seconds._": [
        "Cập nhật thành công. Đang chuyển hướng bạn tới Nextcloud trong %ngiây."
    ],
    ...
    "_{count} search result in another folder_::_{count} search results in other folders_": [
        "{count} kết quả tìm kiếm trong các thư mục khác"
    ],
    "Personal": "Cá nhân",
    "Users": "Người dùng",
    "Apps": "Ứng dụng",
    ...
    "For information how to properly configure your server, please see the <a href=\"%s\" target=\"_blank\" rel=\"noreferrer noopener\">documentation</a>.": "Để biết thông tin về cách định cấu hình đúng máy chủ của bạn, vui lòng xem <a href=\"%s\" target=\"_blank\" rel=\"noreferrer noopener\"> tài liệu </a>. ",
    ...
    "We have detected multiple invalid login attempts from your IP. Therefore your next login is throttled up to 30 seconds.": "Chúng tôi đã phát hiện nhiều lần đăng nhập không hợp lệ từ IP của bạn. Do đó thông tin đăng nhập tiếp theo của bạn được điều chỉnh tối đa 30 giây. ",
    "Stay logged in": "Lưu lại đăng nhập",
    ...
    "For help, see the  <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">documentation</a>.": "Để được trợ giúp, hãy xem <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\"> tài liệu </a>. ",
    ...
    "There was an error loading your contacts": "Đã xảy ra lỗi khi tải địa chỉ liên hệ của bạn ",
    "Your web server is not yet set up properly to allow file synchronization because the WebDAV interface seems to be broken.": "Máy chủ web của bạn chưa được thiết lập đúng cách để cho phép đồng bộ hóa tệp vì giao diện WebDAV dường như bị hỏng. ",
    "Your web server is not set up properly to resolve \"{url}\". Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>.": "Máy chủ web của bạn không được thiết lập đúng cách để giải quyết \"{url}\". Bạn có thể tìm thêm thông tin trong <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\"> tài liệu </a> của chúng tôi. ",
    "This server has no working Internet connection: Multiple endpoints could not be reached. This means that some of the features like mounting external storage, notifications about updates or installation of third-party apps will not work. Accessing files remotely and sending of notification emails might not work, either. We suggest to enable Internet connection for this server if you want to have all features.": "Máy chủ này không có kết nối Internet hoạt động: Không thể kết nối nhiều điểm cuối. Điều này có nghĩa là một số tính năng như gắn bộ nhớ ngoài, thông báo về cập nhật hoặc cài đặt ứng dụng của bên thứ ba sẽ không hoạt động. Truy cập các tập tin từ xa và gửi email thông báo có thể không hoạt động. Chúng tôi khuyên bạn nên bật kết nối Internet cho máy chủ này nếu bạn muốn có tất cả các tính năng. ",
    "No memory cache has been configured. To enhance your performance please configure a memcache if available. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>.": "Không có bộ nhớ cache nào được định cấu hình. Để nâng cao hiệu suất của bạn, hãy định cấu hình memcache nếu có. Bạn có thể tìm thêm thông tin trong <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\"> tài liệu </a> của chúng tôi. ",
    "/dev/urandom is not readable by PHP which is highly discouraged for security reasons. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>.": "/ dev / urandom không thể đọc được bởi PHP vốn không được khuyến khích vì lý do bảo mật. Bạn có thể tìm thêm thông tin trong <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\"> tài liệu </a> của chúng tôi. ",
    "You are currently running PHP {version}. We encourage you to upgrade your PHP version to take advantage of <a target=\"_blank\" rel=\"noreferrer\" href=\"{phpLink}\">performance and security updates provided by the PHP Group</a> as soon as your distribution supports it.": "Bạn hiện đang chạy PHP {version}. Chúng tôi khuyến khích bạn nâng cấp phiên bản PHP của mình để tận dụng <a target=\"_blank\" rel=\"noreferrer\" href=\"{phpLink}\"> các cập nhật về hiệu suất và bảo mật do Nhóm PHP </a> cung cấp ngay khi phân phối của bạn hỗ trợ nó. ",
    "The reverse proxy headers configuration is incorrect, or you are accessing Nextcloud from a trusted proxy. If you are not accessing Nextcloud from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to Nextcloud. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>.": "Cấu hình tiêu đề proxy ngược không chính xác hoặc bạn đang truy cập Nextcloud từ proxy đáng tin cậy. Nếu bạn không truy cập Nextcloud từ proxy đáng tin cậy, đây là vấn đề bảo mật và có thể cho phép kẻ tấn công giả mạo địa chỉ IP của họ hiển thị với Nextcloud. Bạn có thể tìm thêm thông tin trong <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\"> tài liệu </a> của chúng tôi. ",
    "Memcached is configured as distributed cache, but the wrong PHP module \"memcache\" is installed. \\OC\\Memcache\\Memcached only supports \"memcached\" and not \"memcache\". See the <a target=\"_blank\" rel=\"noreferrer\" href=\"{wikiLink}\">memcached wiki about both modules</a>.": "Memcached được cấu hình như bộ nhớ cache phân tán, nhưng mô-đun PHP sai \"memcache\" được cài đặt. \\ OC \\ Memcache \\ Memcached chỉ hỗ trợ \"memcached\" chứ không phải \"memcache\". Xem <a target=\"_blank\" rel=\"noreferrer\" href=\"{wikiLink}\"> wiki được ghi nhớ về cả hai mô-đun </a>. ",
    "Some files have not passed the integrity check. Further information on how to resolve this issue can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>. (<a href=\"{codeIntegrityDownloadEndpoint}\">List of invalid files…</a> / <a href=\"{rescanEndpoint}\">Rescan…</a>)": "Một số tệp chưa vượt qua kiểm tra tính toàn vẹn. Bạn có thể tìm thêm thông tin về cách giải quyết vấn đề này trong <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\"> tài liệu </a> của chúng tôi. (<a href=\"{codeIntegrityDownloadEndpoint}\"> Danh sách các tệp không hợp lệ ... </a> / <a href=\"{rescanEndpoint}\"> Rescan… </a>) ",
    ...
    "The PHP function \"set_time_limit\" is not available. This could result in scripts being halted mid-execution, breaking your installation. We strongly recommend enabling this function.": "Chức năng PHP \"set_time_limit\" không khả dụng. Điều này có thể dẫn đến các tập lệnh bị tạm dừng giữa quá trình thực thi, phá vỡ cài đặt của bạn. Chúng tôi đặc biệt khuyên bạn nên bật chức năng này. ",
    "Your data directory and your files are probably accessible from the Internet. The .htaccess file is not working. It is strongly recommended that you configure your web server in a way that the data directory is no longer accessible or you move the data directory outside the web server document root.": "Thư mục dữ liệu của bạn và các tệp của bạn có thể truy cập được từ Internet. Tệp .htaccess không hoạt động. Chúng tôi khuyên bạn nên định cấu hình máy chủ web của mình theo cách mà thư mục dữ liệu không thể truy cập được nữa hoặc bạn di chuyển thư mục dữ liệu bên ngoài gốc tài liệu máy chủ web. ",
    "The \"{header}\" HTTP header is not configured to equal to \"{expected}\". This is a potential security or privacy risk and we recommend adjusting this setting.": "Tiêu đề HTTP \"{header}\" không được định cấu hình bằng \"{expected}\". Đây là rủi ro bảo mật hoặc quyền riêng tư tiềm ẩn và chúng tôi khuyên bạn nên điều chỉnh cài đặt này. ",
    "The \"Strict-Transport-Security\" HTTP header is not configured to at least \"{seconds}\" seconds. For enhanced security we recommend enabling HSTS as described in our <a href=\"{docUrl}\" rel=\"noreferrer\">security tips</a>.": "Tiêu đề HTTP \"Nghiêm ngặt Giao thông-Bảo mật\" không được định cấu hình trong ít nhất \"{giây}\" giây. Để tăng cường bảo mật, chúng tôi khuyên bạn nên bật HSTS như được mô tả trong <a href=\"{docUrl}\" rel=\"noreferrer\"> mẹo bảo mật </a> của chúng tôi. ",
    "You are accessing this site via HTTP. We strongly suggest you configure your server to require using HTTPS instead as described in our <a href=\"{docUrl}\">security tips</a>.": "Bạn đang truy cập trang web này qua HTTP. Chúng tôi đặc biệt khuyên bạn nên định cấu hình máy chủ của mình để yêu cầu sử dụng HTTPS thay vì được mô tả trong <a href=\"{docUrl}\"> mẹo bảo mật </a> của chúng tôi. ",
    "Shared with {recipients}": "Được chia sẻ với {recipient} ",
    "The server encountered an internal error and was unable to complete your request.": "Máy chủ đã gặp lỗi nội bộ và không thể hoàn thành yêu cầu của bạn. ",
    "Please contact the server administrator if this error reappears multiple times, please include the technical details below in your report.": "Vui lòng liên hệ với quản trị viên máy chủ nếu lỗi này xuất hiện lại nhiều lần, vui lòng bao gồm các chi tiết kỹ thuật bên dưới trong báo cáo của bạn. ",
    "For information how to properly configure your server, please see the <a href=\"%s\" target=\"_blank\" rel=\"noreferrer\">documentation</a>.": "Để biết thông tin về cách định cấu hình đúng máy chủ của bạn, vui lòng xem <a href=\"%s\" target=\"_blank\" rel=\"noreferrer\"> tài liệu </a>. ",
    "This action requires you to confirm your password:": "Hành động này yêu cầu bạn xác nhận mật khẩu của mình: ",
    "Wrong password. Reset it?": "Sai mật khẩu. Đặt lại? ",
    "You are about to grant \"%s\" access to your %s account.": "Bạn sắp cấp quyền truy cập \"% s\" vào tài khoản% s của mình. ",
    "You are accessing the server from an untrusted domain.": "Bạn đang truy cập máy chủ từ miền không đáng tin cậy. ",
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. An example configuration is provided in config/config.sample.php.": "Vui lòng liên hệ với quản trị viên của bạn. Nếu bạn là quản trị viên của cá thể này, hãy định cấu hình cài đặt \"trusted_domains\" trong config / config.php. Một cấu hình ví dụ được cung cấp trong config / config.sample.php. ",
