   ...
   "core",
{
    ...
    "Error when assembling chunks, status code {status}": "Lỗi khi lắp ráp các khối, mã trạng thái {status} ",
    "Actions": "Actions",
    "Download": "Tải về",
    "Rename": "Sửa tên",
    ...
    "_including %n hidden_::_including %n hidden_": [
        "Bao gồm %n ẩn"
    ],
    "You don’t have permission to upload or create files here": "Bạn không có quyền upload hoặc tạo files ở đây",
    "_Uploading %n file_::_Uploading %n files_": [
        "Đang tải lên %n tập tin"
    ],
    "New": "Tạo mới",
    "{used} of {quota} used": "{used} / {quota} đã sử dụng ",
    "{used} used": "{used} đã sử dụng ",
    "\"{name}\" is an invalid file name.": "\"{name}\" không được chấp nhận",
    "File name cannot be empty.": "Tên file không được rỗng",
    "\"/\" is not allowed inside a file name.": "\"/\" không được phép bên trong tên tệp. ",
    ...
    "You created an encrypted file in {file}": "Bạn đã tạo tệp được mã hóa trong {file} ",
    "{user} created {file}": "{user} đã tạo {file}",
    "{user} created an encrypted file in {file}": "{user} đã tạo tệp được mã hóa trong {file} ",
    ...
    "You deleted an encrypted file in {file}": "Bạn đã xóa tệp được mã hóa trong {file} ",
    "{user} deleted {file}": "{user} đã xóa {file}",
    "{user} deleted an encrypted file in {file}": "{user} đã xóa tệp được mã hóa trong {file} ",
    ...
    "A file or folder has been <strong>changed</strong> or <strong>renamed</strong>": "Tệp hoặc thư mục đã được <strong> thay đổi </ strong> hoặc <strong> đổi tên </ strong> ",
    ...
    "Limit notifications about creation and changes to your <strong>favorite files</strong> <em>(Stream only)</em>": "Giới hạn thông báo về việc tạo và thay đổi <strong> tệp yêu thích của bạn </ strong> <em> (Chỉ luồng) </ em> ",
    ...
    "%s of %s used": "% s trong số% s được sử dụng ",
    "%s used": "% s được sử dụng ",
    "Settings": "Cài đặt",
    "Show hidden files": "Hiển thị cac file bị ẩn",
    "WebDAV": "WebDAV",
    "Use this address to <a href=\"%s\" target=\"_blank\" rel=\"noreferrer noopener\">access your Files via WebDAV</a>": "Sử dụng địa chỉ này để <a href=\"%s\" target=\"_blank\" rel=\"noreferrer noopener\"> truy cập Tệp của bạn qua WebDAV </a> ",
    ...
    "No favorites yet": "Chưa có mục yêu thích nào ",
    ...
    "New text file.txt": "Tập tin văn bản mới.txt ",
    "Move": "Di chuyển ",
    "A new file or folder has been <strong>deleted</strong>": "Một tệp hoặc thư mục mới đã bị <strong> xóa </ strong> ",
    "A new file or folder has been <strong>restored</strong>": "Một tệp hoặc thư mục mới đã được <strong> khôi phục </ strong> ",
